...
const APP_VERSION = '55.0.0-functionality-stabilization-audit';
...
function requireActionApproval(db, currentUser, body = {}, perm = 'pos.void') {
  ...
  if (pin && verifyManagerPin(db, pin)) return { method: 'manager-pin', byUserId: null, by: 'Manager PIN' };
